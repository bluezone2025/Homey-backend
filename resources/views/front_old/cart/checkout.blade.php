...
<!-- Favicons -->
    ...
    <style>
        .nav-tabs .nav-link.active, .nav-tabs .nav-item.show .nav-link{
            ...
            border-color: #a88e31 #dee2e6 #fff;
            color: #fff !important;
        }
    </style>
    ...
    <!-- Event snippet for تسوقي من ترندات conversion page -->
    <script>
        gtag('event', 'conversion', {
            'send_to': 'AW-11381103511/kmA_CM_b47UZEJe397Iq',
            'value': 0.1,
            'currency': 'USD',
            'transaction_id': ''
        });
...
<header class="main-header navbar-light header-sticky header-sticky-smart header-03 mb-5 pb-2" style="    border-bottom: 1px solid #c1bbbb;">
    ...
    <main id="content">
            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-site py-0 d-flex justify-content-center">
                        ...
                        <li class="breadcrumb-item active pl-0 d-flex align-items-center" aria-current="page">{{__('site.Shipping Details')}}</li>
                    </ol>
                </nav>
            </div>
        </section>
        ...
        <section class="pb-lg-13 pb-11">
            <div class="container">
                <h4 class="text-center my-8">{{__('site.Shipping Details')}}</h4>
                <form method="post" name="checkout" action="{{route("checkout.store")}}" id="main-form">
                    @csrf
                    @if(session('error'))
                    ...
                    <div class="row">
                        <div class="col-lg-4 pb-lg-0 pb-11 order-lg-last">
                            <div class="card border-0" style="box-shadow: 0 0 10px 0 rgba(0,0,0,0.1)">
                                <div style="max-height: 300px; overflow: auto;" class="card-header bg-transparent py-5">
                                    <h4 class="fs-24 mb-5">@lang('site.Order details')</h4>
                                                ...
                                                <div class="media w-100 mb-4">
                                                    ...
                                                    <div class="media-body d-flex">
                                                        <div class="cart-price pr-6">
                                                            <a href="{{route("product",$product->id)}}" class="text-secondary">{{$product->name}}</a>
                                ...
                                <div class="card-body px-6 pt-5">
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <span class="d-block ml-auto text-secondary font-weight-bold">{{get_price_helper($total,true)}}</span>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <span>{{__('site.Shipping')}} :</span>
                                        <span class="d-block ml-auto text-secondary font-weight-bold" id="test3">{{get_price_helper(0)}}</span>
                                    </div>

                                </div>
                                <div class="card-footer bg-transparent px-0 pb-1 mx-6">
                                    <div class="d-flex align-items-center font-weight-bold mb-3">
                                        <span class="text-secondary"> {{__('site.ORDER TOTAL')}}:</span>
                                        <span class="d-block ml-auto text-secondary fs-24 font-weight-bold" id="total_show">{{get_price_helper($total,true)}}</span>
                                    </div>
                                    ...
                                    @endif
                                    <hr style="background: rgba(0, 0, 0, 0.125) !important; opacity: 0.6 !important;"/>
                                    ...
                                    <div>
                                            ...
                                            <div class="d-flex align-items-center font-weight-bold my-2">
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="buy-22"  name="type" value="cash" checked="checked" class="custom-control-input">
                                                    <label class="custom-control-label custom-control-label-secondary" for="buy-22">
                              <span class="text-body">
                                 @lang('site.Cash on delivery')
                              </span>
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="d-flex align-items-center font-weight-bold mb-3">
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="buy-11" name="type" value="knet" class="custom-control-input">
                                                    <label class="custom-control-label custom-control-label-secondary" for="buy-11">
                              <span class="text-body">
                              <img src="{{asset('assets/design')}}/images/cash.png"/>
                              </span>
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex align-items-center font-weight-bold mb-3">
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="buy-12" name="type" value="pay_with_tabby" class="custom-control-input">
                                                    <label class="custom-control-label custom-control-label-secondary" for="buy-12">
                                                      <span class="text-body">
                                                      <img style="width: 40px" src="{{asset('assets/design')}}/images/tabby.png"/>

                                                        @lang('site.Divide it by 4. No interest, no fees.')                                                      </span>
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        @if(auth('web')->check())
                                            <div class="d-flex align-items-center font-weight-bold mb-3">
                                                <div class="custom-control custom-radio ">
                                                    ...
                                                    <label class="custom-control-label custom-control-label-secondary" for="buy-13">
                                                          <span class="text-body">
                                                              @php
            ...
            $totalWithdraw = 0;
                                                              ...
                                                              @endphp
                                                          <img style="width: 40px" src="{{asset('assets/design')}}/images/wallet.jpeg"/>
...
ادفع من محفظتك
                                        ...
                                        @endif
                                            ...
                                            <p>
                                                @lang('site.Your personal data will be used to process your request, support your experience throughout this website and for other purposes described in')
                                                <a href="https://trendatt.com/ar/info/PrivacyPolicy" target="_blank" style="color: var(--info ) !important;">@lang('site.privacy_policy')</a>

                                            </p>
                                            <hr style="background: rgba(0, 0, 0, 0.125) !important; opacity: 0.6 !important;"/>
                                            <div class="d-none d-md-block custom-control custom-checkbox mt-6 mb-5">
                                                ...
                                                <label class="custom-control-label custom-control-label-secondary text-secondary" for="customCheck5">
                                                    <span class="text-body">@lang('site.Accept the terms and conditions')</span>
                                                </label>
                                            </div>
                                            <button  type="submit" class="d-none d-md-block btn btn-secondary bg-hover-primary border-hover-primary px-7 mb-4">
                                                @lang('site.Fulfill the request')
                                            </button>
                        ...
                        <div class="col-lg-8 pr-xl-15 order-lg-first form-control-01">
                            @if(!auth('web')->check())
                                <p class="mb-2">@lang('site.Repeat customer?')

                                    <a href="#" class="mx-3" style="color: var(--info) !important;" data-toggle="modal" data-target="#sign-in">
                                        @lang('site.Click here to log in')
                                    </a>
                                </p>
                            @endif
                            <p>@lang('site.Do you have a coupon?')<a data-toggle="collapse" class="mx-3" style="color: var(--info) !important;" href="#collapsecoupon" role="button"
                                                 aria-expanded="false" aria-controls="collapsecoupon">
                                    @lang('site.Click here to enter your code')
                                </a></p>
                            <div class="card collapse mw-460 border-0" id="collapsecoupon">
                                <div class="card-body pt-6 px-5 pb-7 my-6 border">
                                    <p class="card-text text-secondary mb-5">@lang('site.If you have a coupon please redeem it here')</p>
                                    <div class="input-group">
                                        <input type="text" name="coupon_code" class="form-control "
                                               placeholder="@lang('site.Discount Code*')">
                                        {{--<div class="input-group-append">
                                            <button class="btn btn-secondary px-3 "name="apply_coupon"
                                                    value="Apply coupon">تنفيذ الكوبون
                                            </button>
                                        </div>--}}
                            ...
                            <h4 class="fs-24 pt-1 mb-2">@lang('site.Shipping Information')</h4>
                            <span class="d-block mb-2 require-text">@lang('site.All Fields with * are required!')</span>

                                <!-- Nav tabs -->
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link active" id="by-address-tab" data-toggle="tab" href="#by-address" role="tab" aria-controls="by-address" aria-selected="true">
                                            @lang('site.Delivery to the address')
                                        </a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link" id="by-phone-tab" data-toggle="tab" href="#by-phone" role="tab" aria-controls="by-phone" aria-selected="false">
                                            @lang('site.Phone Delivery')
                                        </a>
                                    </li>
                                </ul>
                                <div class="tab-content" id="myTabContent" style="margin: 20px 0px">
                                    <div class="tab-pane fade show active" id="by-address" role="tabpanel" aria-labelledby="by-address-tab">
                                        <div class="mb-3">
                                            <label class="mb-2 fs-13 letter-spacing-01 font-weight-600 text-uppercase"> {{__('site.full name')}} *</label>
                                            <div class="row">
                                                <div class="col-md-12 mb-md-0 mb-4">
                                                    <input type="text" class="form-control by-address-field" id="first-name" name="username"
                                        ...
                                        <div class="mb-3">
                                            <div class="row">
                                                <div class="col-md-6 mb-md-0 mb-4">
                                                    <label class="mb-2 fs-13 letter-spacing-01 font-weight-600 text-uppercase">{{__('site.Phone')}} *</label>
                                                    <input type="number" class="form-control by-address-field" name="phone2"
                                                           placeholder="{{__('site.Phone')}}" required="">
                                                </div>
                                                <div class="col-md-6 mb-md-0 mb-4">
                                                    <label class="mb-2 fs-13 letter-spacing-01 font-weight-600 text-uppercase">  {{__('site.Email address')}} *</label>
                                                    <input type="email" class="form-control by-address-field" name="email"
                                        ...
                                        <div class="mb-3">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <label
                                                            class="mb-2 fs-13 letter-spacing-01 font-weight-600 text-uppercase">{{__('site.country')}} *</label>
                                                    <select name="country"  class="form-control by-address-field" style="height: 55px;" id="Orders_city_id" required>
                                                ...
                                                <div class="col-md-6">
                                                    <label
                                                            class="mb-2 fs-13 letter-spacing-01 font-weight-600 text-uppercase">{{__('site.city')}} *</label>
                                                    <div class="dropdown show lh-1 " style="background-color:#f5f5f5">
                                                        <select name="city"  class="form-control by-address-field" id="test" style="height: 55px;" required>
                                        ...
                                        <div class="mb-3">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <label
                                                            class="mb-2 fs-13 letter-spacing-01 font-weight-600 text-uppercase">{{__('site.region')}} *</label>
                                                    <input type="text" class="form-control by-address-field"
                                        ...
                                        <div class="mb-3">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <label
                                                            class="mb-2 fs-13 letter-spacing-01 font-weight-600 text-uppercase">{{__('site.piece')}} *</label>
                                                    <input type="text" class="form-control by-address-field"
                                        ...
                                        <div class="mb-3">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <label
                                                            class="mb-2 fs-13 letter-spacing-01 font-weight-600 text-uppercase">{{__('site.avenue')}} *</label>
                                                    <input type="text" class="form-control by-address-field"
                                                           placeholder="{{__('site.avenue')}}" name="avenue" required="">
                                                </div>
                                        ...
                                        <div class="mb-3">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <label
                                                            class="mb-2 fs-13 letter-spacing-01 font-weight-600 text-uppercase">{{__('site.street')}} *</label>
                                                    <input type="text" class="form-control by-address-field"
                                                           placeholder="{{__('site.street')}}" name="street" required="">
                                                </div>
                                        ...
                                        <div class="mb-3">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <label
                                                            class="mb-2 fs-13 letter-spacing-01 font-weight-600 text-uppercase">{{__('site.flat_number')}} *</label>
                                                    <input type="text" class="form-control by-address-field"
                                                           placeholder="{{__('site.flat_number')}}" name="flat_number" required="">
                                                </div>
                                        ...
                                        <div class="mb-3">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <label
                                                            class="mb-2 fs-13 letter-spacing-01 font-weight-600 text-uppercase">{{__('site.house_number')}} *</label>
                                                    <input type="text" class="form-control by-address-field"
                                                           placeholder="{{__('site.house_number')}}" name="house_number" required="">
                                                </div>
                                        ...
                                        <div class="mb-3">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <label
                                                            class="mb-2 fs-13 letter-spacing-01 font-weight-600 text-uppercase">{{__('site.floor')}} *</label>
                                                    <input type="text" class="form-control by-address-field"
                                                           placeholder="{{__('site.floor')}}" name="floor" required="">
                                                </div>
                                        ...
                                        <div class="form-group">
                                            <input type="hidden" class="form-control by-address-field" name="postcode" value="0" >
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <div class="row">
                                                <div class="col-md-12 mb-md-0 mb-4">
                                                    ...
                                                    <input type="text" class="form-control by-address-field" id="street-address" placeholder="{{__('site.address')}}"
                                        ...
                                        <div class="mb-3">
                                            <div class="row">
                                                <div class="col-md-12 mb-md-0 mb-4">
                                                    ...
                                                    <textarea name="notes" class="form-control by-address-field"></textarea>
                                                </div>
                                            ...
                                            <div class="d-sm-block d-md-none d-lg-none custom-control custom-checkbox mt-6 mb-5">
                                                <input type="checkbox" class="custom-control-input" name="customCheck6" checked="" id="customCheck5">
                                                <label class="custom-control-label custom-control-label-secondary text-secondary" for="customCheck5">
                                                    <span class="text-body">الموافقة على الشروط والاحكام</span>
                                                </label>
                                            </div>
                                            <button type="submit" class="d-sm-block d-md-none d-lg-none btn btn-secondary bg-hover-primary border-hover-primary px-7 mb-4">تنفيذ الطلب
                                            </button>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="by-phone" role="tabpanel" aria-labelledby="by-phone-tab">
                                        <input type="hidden" name="delivered_by" value="phone" class="by-phone-field">
                                        <div class="mb-3">
                                            <label class="mb-2 fs-13 letter-spacing-01 font-weight-600 text-uppercase"> {{__('site.full name')}} *</label>
                                            <div class="row">
                                                <div class="col-md-12 mb-md-0 mb-4">
                                                    <input type="text" class="form-control by-phone-field" id="first-name" name="username"
                                                           placeholder="{{__('site.full name')}}" required="required">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            <div class="row">
                                                <div class="col-md-12 mb-md-0 mb-4">
                                                    <label class="mb-2 fs-13 letter-spacing-01 font-weight-600 text-uppercase by-phone-field">{{__('site.Phone')}} *</label>
                                        ...
                                        <div class="mb-3">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <label
                                                            class="mb-2 fs-13 letter-spacing-01 font-weight-600 text-uppercase">{{__('site.country')}} *</label>
                                                    <select name="country"  class="form-control by-phone-field" style="height: 55px;" id="Orders_city_id2" required>
                                                        @foreach(\App\Models\Country::get() as $country)
                                                            <option value="{{$country->id}}">{{$country->name}}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-md-6">
                                                    <label
                                                            class="mb-2 fs-13 letter-spacing-01 font-weight-600 text-uppercase">{{__('site.city')}} *</label>
                                                    <div class="dropdown show lh-1 " style="background-color:#f5f5f5">
                                                        <select name="city"  class="form-control by-phone-field" id="test2" style="height: 55px;" required>
                                                            <option value="">{{__('site.city')}}</option>
                                        ...
                                        <div class="mb-3">
                                            <div class="row">
                                                <div class="col-md-12 mb-md-0 mb-4">
                                                    ...
                                                    <textarea name="notes" class="form-control by-phone-field"></textarea>
                                                </div>
    ...
    <footer class="py-5 footer bg-gray justify-content-center text-center" >
        <span>@lang('site.All rights reserved to kocart 2024')</span>
    </footer>
