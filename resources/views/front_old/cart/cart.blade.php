        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-site py-0 d-flex justify-content-center">
                    ...
                    <li class="breadcrumb-item active pl-0 d-flex align-items-center" aria-current="page">{{  __('site.cart') }}
                    </li>
                </ol>
            </nav>
        </div>
    ...
    <section class="pb-11 pb-lg-13">
        <div class="container">
            @if(session('cart'))
                ...
                <h4 class="mt-8 mb-8">{{  __('site.cart') }}
                </h4>
                <div class="row">
                    <div class="col-md-8">
                        <div class="table-responsive-md pb-8 pb-lg-10">
                            <table class="table border text-center justify-content-center align-items-center">
                                ...
                                <tr class="fs-15 font-weight-600 text-uppercase text-secondary">
                                    <th scope="col" class="border-1x">{{__('site.Product name')}}</th>
                                    <th  class="border-1x">{{__('site.QUANTITY')}}</th>
                                    <th  class="border-1x">{{__('site.Price')}}</th>
                                    <th  class="border-1x">{{__('site.SUBTOTAL')}}</th>
                                </tr>
                                </thead>
                                <tbody>
                                    ...
                                    @foreach($items as $key => $details)
                                        ...
                                        <tr class="position-relative">
                                                ...
                                                <div class="media align-items-center justify-content-around">
                                                    <div>
                                                        <form action="{{route("cart.remove")}}" method="get">
                                                            ...
                                                            <button  type="submit" title="delete" style="border: none;color: #fe3843;padding:0px;background: none; cursor: pointer;" class="btn btn-danger btn-sm " ><i class="fal fa-trash text-danger fa-lg"></i></button>
                                                        </form>
                                                    </div>
                                                    <div class="">
                                                    ...
                                                    <div class="">
                                                        <p class="font-weight-500 mb-1 text-secondary"> {{$product->name}}</p>
                                            ...
                                            <td class="align-middle">
                                                <div class="input-group position-relative w-128px m-auto">
                                                    <?php $price = get_price_helper2($details["price"],true) ;?>
                                                    <a id="{{'a_mun_'.$details["id"].'_'.$key}}" {{ $details['quantity'] >= 2 ? "onClick=update_cart(".$details['id'].",".$price.",'minus',".$details['id'].",".$key.");":"" }} data-id="{{ $id }}" href="#" class="down position-absolute pos-fixed-left-center pl-2 z-index-2 {{ $details['quantity'] >= 2 ? 'btn-minus':'btn-minus-des'}} "><i
                                                            class="far fa-minus"></i></a>
                                                    <input name="quantity"
                                                           id="qty_<?=$details["id"]?>_{{$key}}"
                                                           value="<?=(isset($details['quantity']))?$details['quantity']: 1 ?>"
                                                           type="number"
                                                           class="form-control form-control-sm px-6 fs-16 text-center input-quality border-0 h-35px"
                                                           required>
                                                    <a href="#"
                                                       onClick="update_cart('{{$details["id"]}}','{{$price}}','plus','{{$details["id"]}}','{{$key}}');"
                                            ...
                                            <td class="align-middle">
                                                <div class="d-flex justify-content-around align-items-center">
                                                    <p class="mb-0 text-secondary font-weight-bold">{{get_price_helper($details['price'],true)}}</p>

                                                </div>
                                            </td>
                                            <td class="align-middle">
                                                @php
                                                    $sum = get_price_helper2($details['price']) * $details['quantity'];
                                                @endphp
                                                <p class="card-text font-weight-bold fs-14  text-secondary">
                                                    <span class="x_sub_total_price_<?=$details["id"]?>_{{$key}}">{{get_price_helper($sum,true)}}</span>
                                                </p>
                                            </td>
                                        </tr>
                                    @endforeach
                                ...
                                <div class="card border-0" style="box-shadow: 0 0 10px 0 rgba(0,0,0,0.1)">
                                    <div class="card-body px-6 pt-5">
                                        <div class="d-flex align-items-center mb-2">
                                            ...
                                            <span class="d-block ml-auto text-secondary font-weight-bold my_total">{{get_price_helper($total,true)}}</span>
                                        </div>
                                        <div class="d-flex align-items-center">
                                            <span>{{__('site.Shipping')}}:</span>
                                            <span class="d-block ml-auto text-secondary font-weight-bold">{{__('site.Depend on city')}}</span>
                                        </div>
                                    </div>
                                    <div class="card-footer bg-transparent px-0 pb-4 mx-6">
                                        <div class="d-flex align-items-center font-weight-bold mb-3">
                                            ...
                                            <span class="d-block ml-auto text-secondary fs-24 font-weight-bold my_total" id="my_total">{{get_price_helper($total,true)}}</span>
                                        </div>

                                        <a href="{{route("checkout")}}"
                                           class="btn btn-secondary btn-block bg-hover-primary border-hover-primary">{{__('site.Checkout')}}
                                        </a>
                                        <a  href="{{url('/'.app()->getLocale())}}" class="btn btn-secondary btn-block bg-hover-primary border-hover-primary"
            ...
            @else
                <div class="mt-8 mb-8 text-center justify-content-center">
                    <svg class="icon icon-shopping-bag-open-light mb-3" style="font-size: 13rem">
                    ...
                    <a href="{{route('home')}}" class="btn btn-outline-secondary btn-block text-center justify-content-center mt-5 continue_btn">@lang('site.Continue shopping')</a>
...
<script type="text/javascript">
        ...
        $('.btn-minus-des').on('click', function () {
