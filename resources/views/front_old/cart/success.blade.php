            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-site py-0 d-flex justify-content-center">
                        ...
                        <li class="breadcrumb-item active pl-0 d-flex align-items-center" aria-current="page">سلة التسوق
                        </li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5 m-auto">
                        <div class="table-responsive-md py-15 py-lg-10" >
                            <?php $invoice = $order; ?>
                            <table id="myHtml" class="table border text-center justify-content-center align-items-center bill-table">

                                <tbody>
                                <tr class="position-relative">

                                    <td colspan="2" class="align-middle">
                                        <p class="card-text mb-0 font-weight-bold fs-14  text-secondary">
                                ...
                                <tr class="position-relative">
                                    ...
                                    <td class="align-middle">
                                        <p class="card-text mb-0 font-weight-bold fs-14  text-secondary">
                                            <span>رقم الفانورة</span>
                                        </p>
                                    </td>
                                    <td class="align-middle">
                                        <div class="d-flex justify-content-around align-items-center">
                                            <p class="mb-0  font-weight-bold"> {{ $invoice->invoice_id ?: $invoice->id }}</p>
                                        </div>
                                    </td>
                                </tr>
                                <tr class="position-relative">
                                    ...
                                    <td class="align-middle">
                                        <p class="card-text mb-0 font-weight-bold fs-14  text-secondary">
                                            <span> سعر الطلب الاجمالي</span>
                                        </p>
                                    </td>
                                    <td class="align-middle">
                                        <div class="d-flex justify-content-around align-items-center">
                                            <p class="mb-0  font-weight-bold"> {{ $invoice->total_price }}  @lang('site.kwd')</p>
                                        </div>
                                    </td>
                                </tr>
                                {{--<tr class="position-relative">
                                    ...
                                    <td class="align-middle">
                                        <div class="d-flex justify-content-around align-items-center">
                                            <p class="mb-0  font-weight-bold"> {{ @$invoice->shipping_address->email }}</p>
                                        </div>
                                    </td>
                                </tr>--}}
                                <tr class="position-relative">
                                    ...
                                    <td class="align-middle">
                                        <div class="d-flex justify-content-around align-items-center">
                                            <p class="mb-0  font-weight-bold"> {{ $invoice->shipping_address->phone . ' ' }}</p>
                                        </div>
                                    </td>
                                </tr>
                                <tr class="position-relative">
                                    ...
                                    <td class="align-middle">
                                        <p class="card-text mb-0 font-weight-bold fs-14  text-secondary">
                                            <span> صورة المنتج في الطلب </span>
                                        </p>
                                    </td>
                                    <td class="align-middle">
                                        <div class="d-flex justify-content-around align-items-center">
                                ...
                                {{--@if($invoice->shipping_address->region)
                                    <tr class="position-relative">
                                        <th class="align-middle">
                                            <p class="card-text mb-0 font-weight-bold fs-14  text-secondary"><span>@lang('site.region')</span></p>
                                        </th>
                                        <td class="align-middle">
                                            <div class="d-flex justify-content-around align-items-center">
                                                <p class="mb-0 font-weight-bold">{{ $invoice->shipping_address->region }}</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endif
                                ...
                                @if($invoice->shipping_address->piece)
                                    <tr class="position-relative">
                                        <th class="align-middle">
                                            <p class="card-text mb-0 font-weight-bold fs-14  text-secondary"><span>@lang('site.piece')</span></p>
                                        </th>
                                        <td class="align-middle">
                                            <div class="d-flex justify-content-around align-items-center">
                                                <p class="mb-0 font-weight-bold">{{ $invoice->shipping_address->piece }}</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endif
                                ...
                                @if($invoice->shipping_address->avenue)
                                    <tr class="position-relative">
                                        <th class="align-middle">
                                            <p class="card-text mb-0 font-weight-bold fs-14  text-secondary"><span>@lang('site.avenue')</span></p>
                                        </th>
                                        <td class="align-middle">
                                            <div class="d-flex justify-content-around align-items-center">
                                                <p class="mb-0 font-weight-bold">{{ $invoice->shipping_address->avenue }}</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endif
                                ...
                                @if($invoice->shipping_address->street)
                                    <tr class="position-relative">
                                        <th class="align-middle">
                                            <p class="card-text mb-0 font-weight-bold fs-14  text-secondary"><span>@lang('site.street')</span></p>
                                        </th>
                                        <td class="align-middle">
                                            <div class="d-flex justify-content-around align-items-center">
                                                <p class="mb-0 font-weight-bold">{{ $invoice->shipping_address->street }}</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endif
                                ...
                                @if($invoice->shipping_address->flat_number)
                                    <tr class="position-relative">
                                        <th class="align-middle">
                                            <p class="card-text mb-0 font-weight-bold fs-14  text-secondary"><span>@lang('site.flat_number')</span></p>
                                        </th>
                                        <td class="align-middle">
                                            <div class="d-flex justify-content-around align-items-center">
                                                <p class="mb-0 font-weight-bold">{{ $invoice->shipping_address->flat_number }}</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endif
                                ...
                                @if($invoice->shipping_address->floor)
                                    <tr class="position-relative">
                                        <th class="align-middle">
                                            <p class="card-text mb-0 font-weight-bold fs-14  text-secondary"><span>@lang('site.floor')</span></p>
                                        </th>
                                        <td class="align-middle">
                                            <div class="d-flex justify-content-around align-items-center">
                                                <p class="mb-0 font-weight-bold">{{ $invoice->shipping_address->floor }}</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endif

                                @if($invoice->shipping_address->address)
                                    <tr class="position-relative">
                                        <th class="align-middle">
                                            <p class="card-text mb-0 font-weight-bold fs-14  text-secondary"><span>@lang('site.address')</span></p>
                                        </th>
                                        <td class="align-middle">
                                            <div class="d-flex justify-content-around align-items-center">
                                                <p class="mb-0 font-weight-bold">{{ $invoice->shipping_address->address }}</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endif

                                @if($invoice->shipping_address->name)
                                    <tr class="position-relative">
                                        <th class="align-middle">
                                            <p class="card-text mb-0 font-weight-bold fs-14  text-secondary"><span>@lang('site.name')</span></p>
                                        </th>
                                        <td class="align-middle">
                                            <div class="d-flex justify-content-around align-items-center">
                                                <p class="mb-0 font-weight-bold">{{ $invoice->shipping_address->name }}</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endif--}}
                                ...
                                <tr class="position-relative">
                                    <th class="align-middle">
                                        <p class="card-text mb-0 font-weight-bold fs-14  text-secondary"><span>@lang('site.total_quantity')</span></p>
                                    </th>
                                    <td class="align-middle">
                                        <div class="d-flex justify-content-around align-items-center">
                                            <p class="mb-0 font-weight-bold">{{ $invoice->products_count }}</p>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr class="position-relative">
                                    <th class="align-middle">
                                        <p class="card-text mb-0 font-weight-bold fs-14  text-secondary"><span>@lang('site.payment type')</span></p>
                                    </th>
                                    <td class="align-middle">
                                        <div class="d-flex justify-content-around align-items-center">
                                            <p class="mb-0 font-weight-bold">
                                ...
                                <tr class="position-relative">
                                    ...
                                    <td class="align-middle">
                                        <p class="card-text mb-0 font-weight-bold fs-14  text-secondary">
                                            <span>@lang('site.date_of_order')</span>
                                        </p>
                                    </td>
                                    <td class="align-middle">
                                        <div class="d-flex justify-content-around align-items-center">
                                            <p class="mb-0 font-weight-bold">{{ $invoice->created_at }}</p>
                                        </div>
                                    </td>
                                </tr>
                            ...
                            <button id="btn_convert" class="btn btn-secondary btn-block bg-hover-primary border-hover-primary" value="Check Out">
                                حمل الفاتورة
                            </button>
                        </div>
                    </div>
