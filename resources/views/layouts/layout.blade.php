...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-2XV5DBZGZX"></script>
    <script>
        dataLayer = window.dataLayer || [];  gtag()
        {dataLayer.push(arguments);}
    gtag('js', new Date()); gtag('config', 'G-2XV5DBZGZX');
    </script>
    ...
    <link rel="stylesheet" href="{{asset('assets/design')}}/vendors/fontawesome-pro-5/css/all.css">
    <link rel="stylesheet" href="{{asset('assets/design')}}/vendors/bootstrap-select/css/bootstrap-select.min.css">

    <link rel="stylesheet" href="{{asset('assets/design')}}/vendors/slick/slick.min.css">

    <link rel="stylesheet" href="{{asset('assets/design')}}/vendors/magnific-popup/magnific-popup.min.css">
    <link rel="stylesheet" href="{{asset('assets/design')}}/vendors/jquery-ui/jquery-ui.min.css">
    <!-- <link rel="stylesheet" href="vendors/animate.css"> -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/4.1.1/animate.min.css"/>
    <link rel="stylesheet" href="{{asset('assets/design')}}/vendors/mapbox-gl/mapbox-gl.min.css">
    <link rel="stylesheet" href="{{asset('assets/design')}}/vendors/fonts/font-phosphor/css/phosphor.min.css">
    <link rel="stylesheet" href="{{asset('assets/design')}}/vendors/fonts/tuesday-night/stylesheet.min.css">
    <link rel="stylesheet" href="{{asset('assets/design')}}/vendors/fonts/butler/stylesheet.min.css">
    <link rel="stylesheet" href="{{asset('assets/design')}}/vendors/fonts/a-antara-distance/stylesheet.min.css">
    <!-- Themes core CSS -->
    <!--<link rel="stylesheet" href="https://cdn.rtlcss.com/bootstrap/v4.5.3/css/bootstrap.min.css" integrity="sha384-JvExCACAZcHNJEc7156QaHXTnQL3hQBixvj5RV5buE7vgnNEzzskDtx9NQ4p6BJe" crossorigin="anonymous">-->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-rbsA2VBKQhggwzxH7pPCaAqO46MgnOM80zW1RWuH61DGLwZJEdK2Kadq2F9CUG65" crossorigin="anonymous">

    <link rel="stylesheet" href="{{asset('assets/design')}}/css/themes.css">
    @if(\Illuminate\Support\Facades\App::getLocale()=="en")
        <link rel="stylesheet" href="{{asset('assets/design')}}/css/ltr.css">
    @else
        <link rel="stylesheet" href="{{asset('assets/design')}}/css/rtl.css">
    @endif
    <!-- Favicons -->
    <!-- <link rel="icon" href="images/favicon.jpg"> -->
    <link rel="icon" type="image/png" href="{{asset('assets/design')}}/images/logo.png">
    @yield('style')
    <style>
        ...
        .more-btn:hover{
            ...
            border: 1px solid #af9433 !important;
        }
        .imageSize{
        ...
        @media only screen and (min-width: 1200px) {
            ...
            .brandImage .card a .position-relative,.brandImage .card a .position-relative img{
                height: 100%;
            }
            .brandImage .card .card-body{
                height: 30%;
            }
            .brand_img{
                height: 350px !important;
        ...
        .main-header .navbar .menu-01 .nav-link-2 {
            color: black !important;
        }
        .box .bg-img-cover-center:after{
            opacity: 0.2;
        }
        .ad_img{
            height: 500px;
    ...
    <script>
        ...
        gtag('config', 'G-2XV5DBZGZX');
    </script>

    <meta name="facebook-domain-verification" content="pm0tyrmms8x7ulcc6a1hifrkdqkq6s" />
    ...
    <script>
        ...
        fbq('init', '396224046679413');
        fbq('track', 'PageView');
        @yield('track')
    </script>
    <noscript><img height="1" width="1" style="display:none"
                   src="https://www.facebook.com/tr?id=396224046679413&ev=PageView&noscript=1"
        /></noscript>
    <!-- End Meta Pixel Code -->
...
<header class="main-header navbar-light header-sticky header-sticky-smart header-03">
    ...
    <section style="  background-color: var(--cyan);" class="topbar tobbar-web bg_primaryColor1 w-100 whiteColor">
...
{{--                    <a href="#"--}}
{{--                       class="dropdown-toggle custom-dropdown-toggle text-decoration-none text-secondary p-3 mw-110 position-relative d-block"--}}
{{--                       id="dropdownMenuButton" data-toggle="dropdown"--}}
{{--                       aria-haspopup="true" aria-expanded="false">--}}
{{--                        @lang('site.language')--}}
{{--                    </a>--}}
{{--                    <div class="dropdown-menu custom-dropdown-item" aria-labelledby="dropdownMenuButton">--}}
{{--                        <a class="dropdown-item"  onclick="changeLanguage('ar')">العربية</a>--}}
...
{{--                </div>--}}
                ...
                @else
                    @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                        ...
                        <a class="nav-link " rel="alternate" hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}" style="font-size: 12px">
                            English
                            <span class="LocaleSwitch2__diamond-divider"></span>
                        ...
                        <ul class="nav nav-pills d-flex">
                            <li class="nav-item px-3">
                                <a  href="#" data-toggle="modal" data-target="#sign-in">
                                    ...
                                    <span  class="header_span">@lang('site.log in')</span>
                                </a>
                            </li>
                            <li class="nav-item px-3">
                                <a  href="#" data-toggle="modal" data-target="#sign-in">
                                    <i class='bx bx-user'></i>
                                    <span  class="header_span">@lang('site.register')</span>
                                </a>
                            </li>
                        </ul>
                     @endif
    ...
    <div class="header-above d-none d-xl-block mb-n4">
        <div class="container container-xl">
            <div class="d-flex align-items-center flex-nowrap">
                <div class="px-12 flex-shrink-0  py-6">
                    <div class="d-flex mt-3 mt-xl-0 align-items-center w-100 justify-content-center">
                        <a class="navbar-brand mx-auto d-inline-block py-0"
                           href="{{route('home')}}">
                            <!-- <img src="images/logogogogogo.png" alt="Glowing"> -->
                            <img fetchpriority="high" width="100%" height="100%" loading="eager" src="{{asset('assets/design')}}/images/logo.png" alt="تريندات">
                        </a>
                    </div>
                </div>
                <div class="w-60">
                        ...
                        <div class="d-none d-xl-flex justify-content-xl-center menu-01">
                            <ul class="navbar-nav hover-menu main-menu px-0 mx-xl-n5">
                                <li aria-haspopup="true" aria-expanded="false"
                                    ...
                                    <a class="nav-link nav-link-2 p-0 "
                                       href="{{ route('brands')}}">
                                         @lang('site.womens')
                                ...
                                <li aria-haspopup="true" aria-expanded="false"
                                    class="nav-item dropdown-item-home dropdown py-2 py-xl-7 sticky-py-xl-6 px-0 px-xl-5">
                                    <a class="nav-link nav-link-2 p-0"
                                       href="{{route('productByType','bestProducts')}}">
                                        @lang('site.best')
                                ...
                                <li aria-haspopup="true" aria-expanded="false"
                                    class="nav-item dropdown-item-home dropdown py-2 py-xl-7 sticky-py-xl-6 px-0 px-xl-5">
                                    <a class="nav-link nav-link-2 p-0"
                                       href="{{route('productByType','recommendedProducts')}}">
                                        @lang('site.recommended')
                                ...
                                <li aria-haspopup="true" aria-expanded="false"
                                    class="nav-item dropdown-item-home dropdown py-2 py-xl-7 sticky-py-xl-6 px-0 px-xl-5">
                                    <a class="nav-link nav-link-2 p-0"
                                       href="{{route('productByType','offers')}}">
                                        @lang('site.offers')
                                        <span class="caret"></span>
                                    </a>
                ...
                <div class="w-40">
                    <div class="d-flex align-items-center justify-content-end">
                        <ul class="navbar-nav flex-row justify-content-xl-end d-flex flex-wrap text-body py-0 navbar-right">
                            <li class="nav-item">
                                <a class="nav-link pr-3 py-0" href="#" data-toggle="modal" data-target="#search">
                            ...
                            @if(Auth::guard('web')->check())
                            <li class="nav-item">
                                <a class="nav-link pr-3 py-0" href="{{route('account.index')}}">
                            ...
                            <li class="nav-item">
                                ...
                                <a class="nav-link position-relative px-4 py-0" href="{{route('account.index')}}">
                                    <svg class="icon icon-star-light">
                                        <use xlink:href="#icon-star-light"></use>
                                    </svg>
                                    <span class="position-absolute number">{{ Auth::guard('web')->user()->wishlist()->count() }}</span></a>
                            </li>
                            @endif
                                ...
                                <li class="nav-item">
                                    <a class="nav-link position-relative px-4 menu-cart py-0 d-inline-flex align-items-center mr-n2"
                                       ...
                                       data-canvas-options='{"container":".cart-canvas"}'>
                                        ...
                                        <span class="position-absolute number">{{ (session('cart')  !== null )? count(session('cart')): 0  }}</span>
                                    </a>
                                </li>
            ...
            <nav class="navbar navbar-expand-xl px-0 d-block">
                                                   ...
                                                   href="{{ route('vendor',$cat->id) }}">
                                                    <div class="media">
                                                        <div class="media-body">
                                                            <span class="d-block lh-15">{{ $cat->name }}</span>
                                                        </div>
                                                    </div>
                                                </a>
                ...
                <div class="d-flex align-items-center d-xl-none">
                    ...
                    <div class="mx-auto"><a class="navbar-brand d-inline-block mr-0 py-5"
                                            href="{{route('home')}}">
                            <img  src="{{asset('assets/design')}}/images/logo.png" alt="تريندات">
                        </a></div>
{{--                    <div class="dropdown show lh-1 rounded ml-lg-5 ml-0 nav-link ">--}}
{{--                        <a href="#"--}}
{{--                           class="dark-text dropdown-toggle custom-dropdown-toggle text-decoration-none text-secondary p-3 mw-110 position-relative d-block"--}}
{{--                           id="dropdownMenuButton" data-toggle="dropdown"--}}
{{--                           aria-haspopup="true" aria-expanded="false">--}}
{{--                            @lang('site.language')--}}
{{--                        </a>--}}
...
{{--                    </div>--}}
                    ...
                    <div class="navbar-right">
                        ...
                        <a class="nav-link position-relative px-4 menu-cart py-0 d-inline-flex align-items-center mr-n2" href="{{route('cart.show')}}" data-canvas="true" data-canvas-options="{&quot;container&quot;:&quot;.cart-canvas&quot;}">
                            <!--<span class="mr-2 font-weight-bold fs-15">$0.00</span>-->
                            <svg class="icon icon-shopping-bag-open-light">
                                <use xlink:href="#icon-shopping-bag-open-light"></use>
                            </svg>
...
{{--                            <a class="nav-link position-relative px-4 menu-cart py-0 d-inline-flex align-items-center mr-n2" href="{{route('account.index')}}" data-canvas="true" data-canvas-options="{&quot;container&quot;:&quot;.cart-canvas&quot;}">--}}
{{--                                <!--<span class="mr-2 font-weight-bold fs-15">$0.00</span>-->--}}
{{--                                <svg class="icon icon-shopping-bag-open-light">--}}
{{--                                    <use xlink:href="#icon-star-light"></use>--}}
{{--                                </svg>--}}
{{--                                <span class="position-absolute number">{{ Auth::guard('web')->user()->wishlist()->count() }}</span>--}}
{{--                            </a>--}}
{{--                        @endif--}}
        ...
        <div style="margin: -1em 0 1em 0;" class="srch-mob d-flex align-items-center justify-content-center w-100">
            <form style="width: 95%; margin: auto;"  method="get" action="{{route('searching')}}" class="d-flex justify-content-center align-items-center h-100">
                <div class="input-group position-relative mr-auto">
                    <input type="text" name="search" class="form-control form-control bg-transparent border-2x rounded"
        ...
        <header class="topbar top-header-mob d-flex flex-wrap justify-content-between align-items-center bg-gray">
            <div>
                @php($url=env('APP_URL').'/'.app()->getLocale())
                <a class="@if(\Request::url()===$url) active @endif"  href="{{route('home')}}" >
                    <i class='bx bx-user'></i>
                    <span  class="header_span">@lang('site.all')</span>
                </a>
            </div>
            <div>
                @php($url1=env('APP_URL').'/'.app()->getLocale().'/show/bestProducts')
                <a  class="@if(\Request::url()===$url1)) active @endif" href="{{route('productByType','bestProducts')}}" >
                    <i class='bx bx-user'></i>
                    <span  class="header_span">@lang('site.best')</span>
                </a>
            </div>
            <div>
                @php($url2=env('APP_URL').'/'.app()->getLocale().'/show/recommendedProducts')

                <a class="@if(\Request::url()===$url2)) active @endif"  href="{{route('productByType','recommendedProducts')}}" >
                    <i class='bx bx-user'></i>
                    <span  class="header_span">@lang('site.recommended')</span>
                </a>
            </div>
            <div>
                @php($url3=env('APP_URL').'/'.app()->getLocale().'/show/offers')
                <a class="@if(\Request::url()===$url3)) active @endif"  href="{{route('productByType','offers')}}" >
                    <i class='bx bx-user'></i>
                    <span  class="header_span">@lang('site.offers')</span>
                </a>
            </div>
...
<footer class="py-5 footer bg-gray d-none d-lg-block" >
    <div class="container container-xl">
        <div class="row">
            <div class="col-lg col-md-4 col-12 mb-7 mb-lg-0">
                <h3 class="fs-20 mb-3">@lang('site.our_data')</h3>
                ...
                <p class="fs-14 lh-185 mb-0">
                    ...
                    <strong class="text-secondary">
                        {{\App\Models\Setting::where('name','phone')->first()->description }}</strong>
                    <br>
                   ...
                   <i class="fas fa-envelope"></i>
                    {{\App\Models\Setting::where('name','email')->first()->description }}
                </p>
            </div>
            <div class="col-lg col-md-4  col-12 mb-7 mb-lg-0">
                <h3 class="fs-20 mb-3">@lang('site.pages')</h3>
                <ul class="list-unstyled mb-0">
                    <li class="pb-1"><a href="{{ route('home') }}" class="text-body lh-175">@lang('site.home')</a></li>
                    <li class="py-1"><a href="{{route('front.info','PrivacyPolicy')}}" class="text-body lh-175">@lang('site.privacy_policy')</a></li>
                    <li class="py-1"><a href="{{route('front.info','TermsAndConditions')}}" class="text-body lh-175">@lang('site.terms_and_conditions')</a></li>
            ...
            <div class="col-lg col-md-4 col-12 mb-7 mb-lg-0">
                <h3 class="fs-20 mb-3">@lang('site.download_app')</h3>
                <ul class="list-unstyled mb-0">
                    <li class="pb-1"><a href="{{\App\Models\Setting::where('name','ios_url')->first()->value }}" class="text-body lh-175">
                            <i class="fab fa-app-store-ios fs-20 "></i>
                            App Store
                        </a></li>
                    <li class="py-1"><a href="{{\App\Models\Setting::where('name','android_url')->first()->value }}" class="text-body lh-175">
            ...
            <div class="col-lg-5 col-12 mb-9 mb-lg-0">
                <h3 class="mb-2">@lang('site.your_email')</h3>
                <p class="lh-2">
                    @lang('site.Leave your email below to receive all the latest news')
                </p>
                <form class="pt-4">
        ...
        <div class="row mt-5 align-items-center">
            <div class="col-12 col-md-6 col-lg-4 d-flex align-items-center order-2 order-lg-1 mt-4 mt-md-7 mt-lg-0">
                <p class="mb-0">© تريندات 2021</p>
                <ul class="list-inline fs-18 ml-3 mb-0">
                    <!-- <li class="list-inline-item mr-4">
                      <a href="#"><i class="fab fa-twitter"></i></a>
                    </li> -->
                    <li class="list-inline-item mr-4">
                        <a href="{{\App\Models\Icon::where('title','facebook')->first()->link }}"><i class="fab fa-facebook-f"></i></a>
                    </li>
                    <li class="list-inline-item mr-4">
                        <a href="{{\App\Models\Icon::where('title','instagram')->first()->link }}"><i class="fab fa-instagram"></i></a>
                    </li>
            ...
            <div class="col-12 col-lg-4 text-md-center order-1 order-lg-2" >
                <img  src="{{asset('assets/design')}}/images/logo.png" alt="تريندات" style="max-width: 179px;">
            </div>
            <div class="col-12 col-md-6 col-lg-4 text-md-right order-3 mt-4 mt-md-7 mt-lg-0" >
                <img src="{{asset('assets/design')}}/images/icon-pay.png" alt="Pay">
            </div>
        </div>
    </div>
</footer>
<!-- Vendors scripts --><!-- Vendors scripts -->
<script src="/assets/design/vendors/jquery.min.js"></script>
<script src="/assets/design/vendors/jquery-ui/jquery-ui.min.js"></script>
<script src="/assets/design/vendors/bootstrap/bootstrap.bundle.js"></script>
<script src="/assets/design/vendors/bootstrap-select/js/bootstrap-select.min.js"></script>
<script src="/assets/design/vendors/waypoints/jquery.waypoints.min.js"></script>
<script src="/assets/design/vendors/counter/countUp.js"></script>
<script src="/assets/design/vendors/magnific-popup/jquery.magnific-popup.min.js"></script>
<script src="/assets/design/vendors/hc-sticky/hc-sticky.min.js"></script>
<script src="/assets/design/vendors/jparallax/TweenMax.min.js"></script>
<script src="/assets/design/vendors/mapbox-gl/mapbox-gl.js"></script>
<script src="/assets/design/vendors/isotope/isotope.js"></script>
<script src="/assets/design/vendors/slick/slick.min.js"></script>


<!-- Theme scripts -->
<script src="{{asset('assets/design')}}/js/theme.js"></script>
...
<div class="mobile-navigation-bar">
    <div class="tab-nav-container mobile-navigationbar">
        <a href="{{route('home')}}">
            <div class="tab tabb active">
                <i class="fas fa-home"></i>
                <p><a href="{{route('home')}}">@lang('site.app_name')</a></p>
            </div>
        </a>
{{--        @if(auth('web')->check())--}}
...
{{--                    <p><a href="{{ route('account.index') }}">المفضلة</a></p>--}}
{{--                </div>--}}
{{--            </a>--}}
{{--        @else--}}
{{--            <a href="{{ route('account.index') }}">--}}
...
{{--        @endif--}}
        ...
        <a href="{{ route('brands', ['type' => 3]) }}">
            <div class="tab tabb">
                ...
                <p><a href="{{ route('brands', ['type' => 3]) }}">@lang('site.brands')
)</a></p>
            </div>
        </a>
        <a href="{{ route('brands')}}">
            <div class="tab tabb">
                ...
                <p><a href="{{ route('brands') }}">@lang('site.famous')</a></p>
            </div>
        </a>
        <a href="{{ route('vendors') }}">
           <div class="tab tabb">
               <i class="fas fa-stream"></i>
               <p><a href="{{ route('vendors') }}">@lang('site.categories')</a></p>
           </div>
       </a>
        @if(auth('web')->check())
        <a href="{{ route('account.index') }}">
            <div class="tab tabb">
                ...
                <p><a href="{{ route('account.index') }}">@lang('site.my_account')</a></p>
            </div>
        </a>
        @else
            <a  href="#" data-toggle="modal" data-target="#sign-in">
                <div class="tab tabb">
                    <i class="fas fa-user"></i>
                    <p><a  href="#" data-toggle="modal" data-target="#sign-in">@lang('site.my_account')</a></p>
                </div>
            </a>
        @endif
{{--        <div class="tab tabb drop-up-btn">--}}
{{--            <i class="fas fa-user"></i>--}}
{{--            <p>حسابي</p>--}}
...
{{--                --}}{{--<li><a class="dropdown-item" href="#">Compare List</a></li>--}}
{{--                @else--}}
{{--                    <div class="buttons">--}}
{{--                        <a href="#" data-toggle="modal" data-target="#sign-in" class="button hvr-sweep-to-left">--}}
{{--                                          <span>--}}
{{--                                              تسجيل الدخول--}}
{{--                                          </span>--}}
{{--                        </a>--}}
...
{{--<div class="animate__animated animate__bounceIn animate__infinite	infinite position-fixed pos-fixed-bottom-left-fam p-6 z-index-10 icon_pad">--}}
{{--    <a href="{{route('brands')}}"--}}
{{--       class="text-decoration-none bg-dark bg-hover-primary shadow  w-90px h-90px  rounded-circle fs-16 d-flex align-items-center justify-content-center">--}}
{{--        المشاهير--}}
{{--    </a>--}}
{{--</div>--}}
{{--<div class="position-fixed pos-fixed-bottom-left p-6 z-index-10 icon_pad">--}}
{{--    <a href="#"--}}
{{--       class="text-decoration-none bg-dark bg-hover-primary shadow  w-60px h-60px  rounded-circle fs-16 d-flex align-items-center justify-content-center"--}}
{{--       data-toggle="modal" data-target="#offers">--}}
{{--        عروض--}}
{{--    </a>--}}
{{--</div>--}}


{{--<div class="animate__animated animate__bounceIn animate__infinite	infinite position-fixed pos-fixed-bottom-left-fam p-6 z-index-10 desktop_only">--}}
{{--    <a href="{{ route('brands', ['type' => 3]) }}"--}}
{{--       class="text-decoration-none bg-dark bg-hover-primary shadow  w-90px h-90px  rounded-circle fs-16 d-flex align-items-center justify-content-center">--}}
{{--        الماركات--}}
{{--    </a>--}}
    ...
    <div class="card border-0 pt-4 pb-7 h-100">
        ...
        <div class="card-header bg-transparent p-0 mx-6">
            ...
            <p class="fs-15 font-weight-500 text-body mb-5"><span class="d-inline-block mr-2 fs-15 text-secondary"><i
                ...
                تم حفظ شريحتك للقادم من <span class="text-secondary">4m34s</span></p>--}}
        </div>
            ...
            @if(session('cart'))
                @foreach(session('cart') as $id => $details)
                    @foreach($details as $key =>  $detail)
                            <?php $price = get_price_helper2($detail["price"],true) ;?>
                        <?php
                                    ...
                                    <div class="media-body d-flex">
                                        <div class="cart-price pr-6">
                                            <p class="fs-14 font-weight-bold text-secondary mb-1">
                                                @if($product->if_sale)
                                                    <span class="font-weight-500 fs-13 text-line-through text-body mr-1">{{get_price_helper($product->sale_price,true)}}</span>
                                                    {{get_price_helper($product->regular_price,true)}}

                                                @else
                                                    {{get_price_helper($product->regular_price,true)}}
                                                @endif
                                            </p>
                                            <a href="{{route("product",$product->id)}}" class="text-secondary">{{$product->name_en}}</a>
                                        </div>
                                        <div class="position-relative ml-auto">
                                            <div class="input-group">
                                                <a href="#"

                                                   id="{{'a_mun_'.$detail["id"].'_'.$key}}" {{ $detail['quantity'] >= 2 ? "onClick=update_cart(".$detail['id'].",".$price.",'minus',".$detail['id'].",".$key.");":"" }}
                                                   class="down position-absolute pos-fixed-left-center pl-2"><i
                                                            class="far fa-minus"></i></a>
                                                <input type="number"
                                                       id="qty_<?=$detail["id"]?>_{{$key}}"
                                                       value="<?=(isset($detail['quantity']))?$detail['quantity']: 1 ?>"
                                                       class="number-cart w-90px px-6 text-center h-40px bg-input border-0" >
                                                <a href="#"

                                                   onClick="update_cart('{{$detail["id"]}}','{{$price}}','plus','{{$detail["id"]}}','{{$key}}');"
        ...
        <div class="card-footer mt-auto border-0 bg-transparent px-6 pb-0 pt-5">
            <div class="d-flex align-items-center mb-2">
                <span class="text-secondary fs-15">@lang('site.total_price')</span>
                <span class="d-block ml-auto fs-24 font-weight-bold text-secondary my_total" id="my_total">{{get_price_helper($price_c??0,true)}}</span>
            </div>
            <a href="{{route('checkout')}}" class="btn btn-secondary btn-block mb-3 bg-hover-primary border-hover-primary">@lang('site.Confirm order')</a>
            <a href="{{route('cart.show')}}" class="btn btn-outline-secondary btn-block ">@lang('site.cart')</a>
        </div>
        @endif
        ...
        <div class="input-group position-relative">
            <div class="input-group-prepend d-none d-md-block">
                <select class="selectpicker"
                    ...
                    <option value="chairs">عسل ابيض</option>
                    <option value="stands">عسل اسود</option>
...
<div class="sidenav canvas-sidebar bg-white">
    ...
    <div class="pt-5 pb-7 card border-0 h-100">
        <div class="d-flex align-items-center card-header border-0 py-0 pl-8 pr-7 mb-9 bg-transparent">
            <a href="{{route('home')}}" class="d-block w-179px">
                <img  src="{{asset('assets/design')}}/images/logo.png">
            </a>
                    ...
                    <ul class="dropdown-menu pt-3 pb-0 pb-xl-3 x-animated x-fadeInUp">
                        ...
                        <li class="dropdown-item">
                            <a
                                ...
                                المتجر بطريقة الجريد
                            </a>
                        </li>
                        <li class="dropdown-item">
                            <a
                                    class="dropdown-link"
                                    href="shop-page-05.html">
                                المتجر بطريقة القائمة
                            </a>
                        </li>
                        <li class="dropdown-item">
                            <a
                                    class="dropdown-link"
                                    href="product-detail-01.html">
                                تفاصيل المنتج
                            </a>
                        </li>
                    </ul>
...
<div class="modal @if(session()->get('open')) show @endif sign-in" @if(session()->get('open')) style="display: block;" @endif id="sign-in" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header border-0 p-6">
                <nav class="w-100">
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <a class="nav-link active" id="nav-log-in-tab" data-toggle="tab" href="#nav-log-in" role="tab" aria-controls="nav-log-in" aria-selected="true">@lang('site.log in')</a>
                        <a class="nav-link" id="nav-register-tab" data-toggle="tab" href="#nav-register" role="tab" aria-controls="nav-register" aria-selected="false">@lang('site.register')</a>
                    </div>
                </nav>
            ...
            <div class="modal-body px-9 pb-8">
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-log-in" role="tabpanel" aria-labelledby="nav-log-in-tab">
                        <h4 class="fs-34 text-center mb-6">@lang('site.log in')</h4>
                        <p class="text-center fs-16 mb-7">@lang("site.Don't have an account?") <a href="#" class="text-secondary border-bottom text-decoration-none">@lang('site.register')</a></p>
                        <form method="POST" action="{{ route('login') }}" aria-label="{{ __('Login') }}">

                        @csrf
                            <input name="phone" type="text" class="form-control border-0 mb-3" placeholder="@lang('site.phone')" required>
                            <input name="password" type="password" class="form-control border-0" placeholder="@lang('site.password')" required>
                            <div class="d-md-flex align-items-center justify-content-between mt-5 mb-4">
                                <div class="custom-control custom-checkbox mb-2 mb-md-0">
                                    ...
                                    <label class="custom-control-label text-body" for="staySignedIn">@lang('site.save_login')</label>
                                </div>
                                <a href="#" class="text-secondary">@lang('site.forgot_your_password')</a>
                            </div>
                            <button type="submit" value="Login" class="btn btn-secondary btn-block bg-hover-primary border-hover-primary">@lang('site.log in')</button>
                        </form>
                    </div>

                    <div class="tab-pane fade" id="nav-register" role="tabpanel" aria-labelledby="nav-register-tab">
                        <h4 class="fs-34 text-center mb-6">@lang('site.register')</h4>
                        <p class="text-center fs-16 mb-7"> @lang('site.Already have an account?')<a href="#" class="text-secondary border-bottom text-decoration-none">@lang('site.log in')</a></p>
                        <form method="POST" action="{{ route('register') }}" aria-label="{{ __('Register') }}">

                        @csrf
                            <input name="name" type="text" class="form-control border-0 mb-3" placeholder="@lang('site.full_name')" required>
                            <input name="email" type="email" class="form-control border-0 mb-3" placeholder="@lang('site.email')" required>
                            <input name="password" type="password" class="form-control border-0 mb-3" placeholder="@lang('site.password')" required>
                            <input name="phone" type="number"
                                   class="form-control border-0" placeholder="@lang('site.phone')" required>
                            ...
                            <div class="custom-control custom-checkbox mt-4 mb-5 mr-xl-6">
                                <input required="required"  name="agree" type="checkbox" class="custom-control-input" id="termsOfUse">
                                <label class="custom-control-label text-body" for="termsOfUse">
                                    @lang('site.agree_to') <a href="#">@lang('site.terms_and_conditions')</a>
                                </label>
                            </div>
                            <button type="submit" value="Login" class="btn btn-secondary btn-block bg-hover-primary border-hover-primary">@lang('site.register')</button>
                        </form>
                    </div>
                </div>
            </div>
...
<div class="modal  sign-in" id="search" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header border-0 p-6">
                <button type="button" class="close opacity-10 fs-32 pt-1 position-absolute" data-dismiss="modal" aria-label="Close" style="right: 30px">
            ...
            <div class="modal-body px-9 pb-8">
                <form action="{{route('searching')}}" class="d-flex align-items-center h-100">
                    <div class="input-group position-relative mw-270 mr-auto">
                        <input type="text" name="search"
                               class="form-control form-control bg-transparent border-2x rounded"
                               placeholder="@lang('site.product_search')">
                        <div class="input-group-append position-absolute pos-fixed-right-center">
                            <button class="input-group-text bg-transparent border-0 px-0 fs-28 pr-3" type="submit">
                                <i class="fal fa-search fs-20 font-weight-normal"></i>
                            </button>
            ...
            <div class="modal-body pt-0">
                <div class="row">
                        ...
                        <div class="galleries-product product galleries-product-02 position-relative">
                            <div class="position-absolute pos-fixed-top-right z-index-2">
                                <div class="content-change-vertical">
                                    <a href="#" data-toggle="tooltip" data-placement="left" title="@lang('site.add_fav')"
                            ...
                            <div class="view-slider-for mx-0">
                                <div class="box px-0" >
                                    <div class="card p-0 rounded-0 border-0">
                                        <a href="images/images/image_651d63672a29c3011.jpeg" class="card-img">
                                            <img src="images/images/image_651d63672a29c3011.jpeg" alt="product gallery">
                                        </a>
                                    </div>
                                </div>
                                <div class="box px-0" >
                    ...
                    <div class="col-md-6 pl-xl-6 pr-xl-8">
                        ...
                        <h2 class="fs-24 mb-2">عسل طبيعي</h2>
                        ...
                        <p class="mb-4 mr-xl-6">من أفضل المنتجات الطبيعية على الاطلاق عسل اصلي طبيعي</p>
                        <p class="mb-2">
                        <form>
...
<div class="modal fade " id="offers" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header border-0 py-0">
                <button type="button" class="close fs-32" data-dismiss="modal" aria-label="Close">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h4 class="m-auto text-center">
                            <a href="#">
                                تسوق أفضل العروض عن طريق Tabby
                            </a>
                        </h4>
                        <img class="mt-2" src="images/Article-Main-Image-4-18.png"/>
                    </div>
                </div>
            </div>
        </div>
...
{{--    const arr=url.split("/");--}}
{{--    let mainUrl=arr[0]+"//"+arr[1]+arr[2]+"/"+language+"/";--}}
{{--    if(arr.length>4){--}}
