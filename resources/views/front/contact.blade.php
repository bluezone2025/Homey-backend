...
<div class="col-md-6 mx-auto regsiter-client ">
<h2 class="text-center" style="color: #a88e31"> Contact us</h2>
<p class="text-center mb-5">We are happy to receive your inquiries and suggestions.</p>
...
<div class="col-sm-9">
<textarea  rows="3" name="msg" class="form-control-plaintext w-100" style="width: 100%;" ></textarea>
</div>
</div>
<div class="form-group row mt-3">
<div class="col-sm-12 justify-content-center d-flex">
<button class="btn btn-dark" type="submit" style="width: fit-content; background-color: #a88e31; color: #fff;">send</button>
</div>
</div>
