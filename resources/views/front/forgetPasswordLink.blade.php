...
<div class="container mt-3">
     <a href="{{route('home')}}">
            <i class="fa-solid fa-arrow-left" style="font-size: 2rem; transform: rotate({{ app()->getLocale() == 'ar' ? '180deg' : '0deg' }});"></i>
        </a>
</div>

<div class="sign container text-center shadow pad-10">
  <br>
                ...
                <form action="{{ route('reset.password.post') }}" method="POST">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <input type="text" id="email_address" class="form-control text-dark w-50 mx-auto" placeholder="@lang('site.email')" name="email" required autofocus>
                                        @if ($errors->has('email'))
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <input type="password" id="password" class="form-control text-dark w-50 mx-auto" name="password" placeholder="{{__('site.password')}}" autofocus>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <input type="password" id="password-confirm" class="form-control text-dark w-50 mx-auto" name="password_confirmation" placeholder="{{__('site.Confirm Password')}}" required autofocus>
                                 ...
                                 <div class="form-group row">
                                       <div class="col-md-12">
                                            <button type="submit" class="btn fit-content btn-dark bg-main">
