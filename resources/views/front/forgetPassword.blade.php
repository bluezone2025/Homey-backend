...
@endif
                ...
                <form action="{{ route('forget.password.post') }}" method="POST">
                    ...
                    <div class="form-group row">
                        <div class="col-12">
                            <input type="text" id="email_address" class="form-control text-dark w-50 mx-auto"  placeholder="@lang('site.email')"
                    ...
                    <button  type="submit" class="btn fit-content btn-dark bg-main"> @lang('site.Send Password Reset Link') </button>
                    <br><br>
                    <a href="{{route('login/client')}}" style="font-weight:bold" class="main-color " >@lang('site.log in')</a><br><br>
