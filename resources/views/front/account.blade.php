...
<head>
    ...
    <title>@lang('site.my_account')</title>
    <!-- Favicons -->
    ...
    @if($has_wishlist==true)
        <style>
            .accordion #headingTwo .icon:before
            ...
            .accordion #headingOne .icon:before
            {
                content: '\f067';
            }
        </style>
    ...
    @if(app()->getLocale()=="ar")
        <style>
            label,option,select,.form-control{
                font-size: 1.4rem;
            }
...
<main id="content">
    ...
    <section class="sec-title1">
        <div class="container">
          ...
          >
                ...
                <b><span>{{__('site.my_account')}}</span></b>
            </div>
        </div>
    </section>
    ...
    <section class="pt-lg-5 pb-0 pb-lg-6 d-block d-lg-block">
        <div class="container">
            <h4 class="mt-4">{{ __('site.my_account') }}

                <label class="@if(app()->getLocale() == 'en') text-left @else text-right @endif  " style="display: block; " dir="ltr">
...
{{__('site.Your wallet balance') .' (' .$totalDeposit - $totalWithdraw .')'}}
                ...
                <div class="col-md-12 mt-4 mt-md-0 mb-7">
                    <div id="accordion-style-01" class="accordion">
                        <div class="card border-0 mb-4">
                            ...
                            <div id="collapseOne" class="collapse @if($has_wishlist==false)show @endif" aria-labelledby="headingOne"
                                        ...
                                        <form method="POST" action="{{route('account.update',$account->id)}}" aria-label="{{ __('site.Edit') }}">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 form-control-01">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12 mb-md-0 mb-4">
                                                                <label for="street-address"
                                                                       class="mb-2 letter-spacing-01 font-weight-600 text-uppercase">
                                                                    {{__('site.full name')}}
                                                                </label>
                                                    ...
                                                    <div class="">
                                                        <label class="mb-2  letter-spacing-01 font-weight-600 text-uppercase">info</label>
                                                        <div class="row">
                                                    ...
                                                    <div class="mt-3">
                                                        <label for="city" class="mb-2 letter-spacing-01 font-weight-600 text-uppercase">
                                                    ...
                                                    <button type="submit" class="btn more-btn px-7 mt-3">@lang('site.Save') </button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                        ...
                        <div class="card border-0 mb-4">
                            ...
                            <div id="collapseTwo" class="collapse @if($has_wishlist==true)show @endif" aria-labelledby="headingTwo" data-parent="#accordion-style-01">
                                <div class="card-body pt-4 pb-1 px-0">
                                    <form class="table-responsive-md pb-8 pb-lg-10">
                                        <table class="table border text-center justify-content-center align-items-center">
                                            ...
                                            <tr class=" font-weight-600 text-uppercase text-secondary">
                                                <th scope="col" class="border-1x">@lang('site.products')</th>
                                                <th  class="border-1x">@lang('site.price')</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            @foreach($wishlists as $item)
                                                <tr class="position-relative">
                                                    ...
                                                    <td class="align-middle">
                                                        <div class="d-flex justify-content-around align-items-center">
                                                            @if($item->if_sale)
                                                                <p class="mb-0 text-secondary font-weight-bold">{{get_price_helper($item->final_sale_price,true)}}</p>
                                                                <p class="mb-0 text-secondary font-weight-bold text-decoration-through" style="color: red !important;">{{get_price_helper($item->final_regular_price,true)}}</p>
                                                            @else
                                                                <p class="mb-0 text-secondary font-weight-bold">{{get_price_helper($item->final_regular_price,true)}}</p>
                                                            @endif
                                            ...
                                            @foreach($orders as $order)
                                                <tr class="position-relative">
                                                    ...
                                                    <td class="align-middle">
                                                        <p class="card-text font-weight-bold  text-secondary">
                                                                <span>
                                                                    <a href="{{url(route("show_invoice",$order->id)) }}" class="btn btn-dark btn-sm"><i class="fa fa-eye" style="color: white !important"></i> @lang('')</a>
                                                                </span>
                                                        </p>
                                                    </td>
                                                </tr>
                                ...
                                <h5 class="mb-0  w-100">
                                    @if (app()->getLocale() == 'en')
                                        @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                            ...
                                            <a  rel="alternate" class="d-flex align-items-center border-bottom pb-2 text-decoration-none collapsed" hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">
                                                   <span>
                                              <div class="d-flex align-items-center ">
                                                ...
                                                <div>
                                                  <span>{{ __('site.change_language') }}</span>
                                                </div>
                                               </div>
                                            </span>
                                            </a>
                                    ...
                                    @else
                                        @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                            ...
                                            <a class="d-flex align-items-center border-bottom pb-2 text-decoration-none collapsed" rel="alternate" hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">
                                                <span>
                                              <div class="d-flex align-items-center ">
                                                <div>
                                                  <span>
                                                      <img src="{{ asset('front/img/en.png') }}" width="20">
                                                  </span>
                                                </div>
                                                <div class="mx-2">
                                                  <span>|</span>
...
@if($has_wishlist == true)
    <script>
        window.onload = function () {
            const wishlist = document.getElementById('headingTwo');
            if (wishlist) {
...
<script>
           ...
           function update_cart(elem,pro_price,factor,item_id,key)
        {
            ...
            var input = document.getElementById('qty_'+elem+'_'+key);
