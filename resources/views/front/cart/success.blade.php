                ...
                <div class="row">
                    <div class="col-md-5 m-auto">
                        <div class="table-responsive-md py-15 py-lg-10" >
                                        ...
                                        <div class="justify-content-around align-items-center">
                                            @foreach ($order->productItems as $item)
                                                ...
                                                <img src="{{ asset("assets/images/products/min/$product->img") }}"
                                                     class="mw-75px mb-2" >
                                                <div class="mb-2 ">
                                                    <p class="mb-0 font-weight-bold d-flex justify-content-center">
                                                    ...
                                                    <small class="d-block text-muted">الكمية: {{ $item->quantity }}</small>
                            ...
                            <button id="btn_convert" class="btn btn-download" value="Check Out">
                                حمل الفاتورة
                            </button>
                        </div>
                    </div>
...
<script>
      $("#btn_convert").on("click", function() {
            html2canvas(document.querySelector("#myHtml"), { scale: 2 }).then(function(canvas) {
