            ...
            <div class="py-3">
                ...
                @if($one->final_sale_price != 0 && $one->final_sale_price < $one->final_regular_price)
                    ...
                    <div class="mt-1 product_price">
                        <div class="d-flex justify-content-between sale_price">
                            <p class="discount">{{ get_price_helper($regular, true) }}</p>
                            <span>{{ $discount }}%</span>
                        </div>
                        <p>{{ get_price_helper($sale, true) }}</p>
                    </div>
                @else
