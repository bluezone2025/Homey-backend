...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page"><span>@lang('layout.add currency')</span></li>
@endsection
                    ...
                    <div class="widget-header">
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                <h4>@lang('layout.add currency')</h4>
                            </div>
                        </div>
                    </div>
                    <div class="widget-content widget-content-area">
                        @include('admin.pages.currencies.form_create')
                    </div>
                </div>
            </div>
        </div>
