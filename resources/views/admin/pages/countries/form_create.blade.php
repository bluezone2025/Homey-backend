<form method="post" action="{{route('admin.countries.store')}}" enctype="multipart/form-data">
    ...
    <div class="form-row mb-4">
        ...
        <div class="form-group col-md-6">
            ...
            <input name="name_ar" type="text" class="form-control @error('name_ar') is-invalid @enderror" id="name_ar" value="{{old('name_ar')}}" required>
        ...
        <div class="form-group col-md-6">
            ...
            <input  name="name_en" type="text" class="form-control @error('name_en') is-invalid @enderror" id="name_en"  value="{{old('name_en')}}" required>
      ...
      {{--  <div class="form-group col-md-6">
       ...
       <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-6">
            <label for="currency_id">@lang('form.label.chang  currency of country')</label>
            <select name="currency_id" class="form-control  @error('country_id') is-invalid @enderror" id="currency_id" required>
