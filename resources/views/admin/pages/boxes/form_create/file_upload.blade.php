        ...
        <div class="widget-header">
            <div class="row">
                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                    <h4 class="req">@lang('form.label.min img box') <span class="size-img"> (250 * 210) </span></h4>
                </div>
            </div>
        </div>
        <div class="widget-content widget-content-area">
            <div class="custom-file-container" data-upload-id="myFirstImage">
                ...
                <label class="custom-file-container__custom-file" >
                    <input name="default_image" type="file" class="custom-file-container__custom-file__custom-file-input" accept="image/*" required>
...
<div id="fuSingleFile" class="col-lg-12 layout-spacing">
    ...
    <div class="statbox widget box box-shadow @error('images') border border-danger @enderror">
        <div class="widget-header">
            <div class="row">
                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                    <h4 class="req">@lang('form.label.gallery img box') <span class="size-img"> (250 * 150) </span></h4>
                </div>
            </div>
        </div>
        <div class="widget-content widget-content-area">
