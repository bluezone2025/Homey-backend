...
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{route('admin.boxes.index')}}">@lang('layout.boxes')</a></li>
    <li class="breadcrumb-item active" aria-current="page"><span>@lang('layout.update box')</span></li>
@endsection
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                        ...
                        <div class="widget-content widget-content-area">
                            @include('admin.pages.boxes.form_update.form')
                        </div>
                    </div>
                </div>
            </div>
...
@section('js')
    ...
    <script>
        $('.required_order').on('change', function(e) {
            e.preventDefault();
            $('#required_order_div').toggleClass('d-none')
        })
    </script>
@endsection
