        ...
        <div class="widget-header">
            <div class="row">
                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                    <h4>@lang('form.label.min img box')</h4>
                </div>
                <div class="col-12 text-center">
                    <img src="{{asset("assets/images/boxes/min/small_$box->default_image")}}" alt="" class="img-fluid border-info" width="200">
                </div>
            </div>
        </div>
        <div class="widget-content widget-content-area">
            <div class="custom-file-container" data-upload-id="myFirstImage">
                ...
                <label class="custom-file-container__custom-file" >
                    <input name="default_image" type="file" class="custom-file-container__custom-file__custom-file-input" accept="image/*" >
...
<div id="fuSingleFile" class="col-lg-12 layout-spacing">
    ...
    <div class="statbox widget box box-shadow @error('images') border border-danger @enderror">
        <div class="widget-header">
            <div class="row">
                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                    <h4>@lang('form.label.gallery img box')</h4>
                </div>
                @foreach($box->images as $img)
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2 text-center mb-2">
                        <img width="90" height="90" src="{{asset("assets/images/boxes/gallery/$img->image")}}" alt="" style="max-width: 100%">
