...
<div class="form-group col-md-6">
    ...
    <input name="seller_name" type="text"  class="form-control @error('seller_name') is-invalid @enderror" id="name_en"  value="{{old('seller_name')}}">
...
<div id="main-quantity-wrapper" class="form-group col-md-6">
