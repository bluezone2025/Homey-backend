...
<body>
    <div class="  col-md-12 d-md-block" style="margin: 20px auto !important; direction: rtl !important;text-align: right !important;">
        <h4  style="direction: rtl !important;text-align: right !important;">
            <span style="direction: rtl !important;text-align: right !important;">
                شكراً لطلبك من أركان – رقم الطلب
            </span>
            <span style="direction: ltr !important;text-align: left !important;">
                {{$order_id}}
            </span>
        </h4>
        <h6 style="direction: rtl !important;text-align: right !important;">مرحبًا {{$username}}،</h6>
        <p style="direction: rtl !important;text-align: right !important;"> نشكر لك ثقتك في أركان!</p>
        <p style="direction: rtl !important;text-align: right !important;">        تم استلام طلبك بنجاح، ويجري الآن العمل على تجهيزه.
        </p>

        <p style="direction: rtl !important;text-align: right !important;">        مرفق مع هذه الرسالة فاتورة الطلب رقم {{$order_id}}، والتي تحتوي على كافة التفاصيل الخاصة بمنتجاتك، طريقة الدفع، وعنوان التوصيل.
        </p>
         <p style="direction: rtl !important;text-align: right !important;">         سنقوم بإبلاغك فور خروج الطلب من المخزن.
         </p>
    ...
    <p style="direction: rtl !important;text-align: right !important;">
        لو عندك أي استفسار أو تعديل، تقدر تتواصل معنا عبر::
