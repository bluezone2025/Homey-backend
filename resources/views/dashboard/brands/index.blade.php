...
@section('page_title') @lang('site.brands') @endsection
        ...
        <div class="row">
            <div class="col-lg-12 margin-tb">
                <div class="pull-right">
                    ...
                    <a class="btn btn-success mb-2" href="{{ route('brands.create') }}">@lang('site.add_brand')</a>
                </div>
            </div>
        </div>
                ...
                <table class="table align-items-center justify-content-center mb-0 data-table  text-secondary text-xs ">
                    <thead>
                        <tr>
                            ...
                            <th width="10%">@lang('site.arkan_percentage')</th>
                            <th width="10%">@lang('site.brand_percentage')</th>
                            <th width="10%">@lang('site.products_count')</th>
                            <th width="10%">@lang('site.has_discount')</th>
                            <th width="10%">@lang('site.discount_type')</th>

                            <th width="10%">@lang('site.discount_percentage')</th>
                            <th width="10%">@lang('site.start_discount_range')</th>
                            <th width="10%">@lang('site.end_discount_range')</th>

                            <th width="10%">@lang('site.brand_logo')</th>
            ...
            var table = $('.data-table').DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                     ...
                     {
                        data: 'arkan_percentage',
                        name: 'arkan_percentage'
                    },
                     {
                        data: 'brand_percentage',
                    ...
                    },
                    {
                     ...
                     {
                        data: 'start_discount_range',
                        name: 'start_discount_range'
                    },
                     {
                        data: 'end_discount_range',
                        name: 'end_discount_range'
                    },
                    {
                        data: 'logo',
                        name: 'logo',
