...
@section('page_title') @lang('site.size_guide') @endsection
        ...
        <div class="row">
            <div class="col-lg-12 margin-tb">
                <div class="pull-right">
                    ...
                    <a class="btn btn-success mb-2" href="{{ route('size_guides.create') }}">@lang('site.new')</a>
                </div>
            </div>
        </div>
        <div class="card-header pb-0">
            <h6>@lang('site.size_guides')</h6>
        </div>
