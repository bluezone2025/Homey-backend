@extends('dashboard.layouts.app')
    ...
    @section('page_title')  @lang('site.notifications')  @endsection
            ...
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    ...
                    <div class="pull-right">
                        {{--                <a class="btn btn-success mb-2" id="new-user" data-toggle="modal">New User</a>--}}
                        <a class="btn btn-success mb-2" href="{{route('notifications.create')}}">@lang('site.add_notification')</a>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body px-0 pt-0 pb-2">
                <div class="table-responsive p-0">
                    <table class="table align-items-center justify-content-center mb-0 data-table  text-secondary text-xs ">
                        ...
                        <tr>
            <th width="5%">No</th>
            <th width="20%">@lang('site.title')</th>
            <th width="20%">@lang('site.created_at')
            </th>
