...
@section('page_title') Edit Preparation : @lang('site.edit_preparation'){{ $preparation->title_ar }} @endsection
...
{{--    <input hidden value="{{$preparation->basic_category->type}}" id="basic_cat_type">--}}
    <form class="card col-md-12 col-12" style="margin: auto" action="{{ route('preparations.update.preparation', $preparation->id) }}"
                    ...
                    <div class="col-md-12 d-flex justify-content-center ">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="has_offer" value="1" id="has_offer"
                                @if ($preparation->has_offer == 1)  {{ 'checked' }} @endif>
            ...
            <div class="d-flex flex-wrap">
                ...
                <div class="form-group col-6">
                    ...
                    <select name="basic_category_id" class="form-control @error('basic_category_id') is-invalid @enderror"
                        ...
                        @foreach ($basic_categories as $basic_category)
                            ...
                            <option value="{{ $basic_category->id }}" @if ($basic_category->id == $preparation->basic_category_id && $preparation->basic_category_id != 0)  {{ 'selected' }} @endif>
                ...
                <div class="form-group col-6">
                    ...
                    <select name="category_id" class="form-control @error('category_id') is-invalid @enderror"
                        id="category_id">
                        @if ($preparation->category_id != 0)

                            @foreach ($categories as $category)


                                <option value="{{ $category->id }}" @if ($category->id == $preparation->category_id)  {{ 'selected' }} @endif>
                ...
                <div class="form-group col-6">
                    ...
                    <input value="{{ $preparation->title_ar }}" type="text" name="title_ar"
                ...
                <div class="form-group col-6">
                    ...
                    <input value="{{ $preparation->title_en }}" type="text" name="title_en"
                ...
                <div class="form-group col-12">
                    ...
                    <textarea name="description_ar" class="form-control @error('description_ar') is-invalid @enderror"
                        id="description_ar">{{ $preparation->description_ar }}</textarea>
                </div>
                ...
                <div class="form-group col-3">
                    ...
                    <input value="{{ $preparation->before_price }}" type="number" step=".01" name="before_price"
                ...
                <div class="form-group col-3">
                    ...
                    <input value="{{ $preparation->price }}" type="number" step=".01" name="price"
        ...
        <input type="hidden" value="{{ $preparation->id }}" name="id">
