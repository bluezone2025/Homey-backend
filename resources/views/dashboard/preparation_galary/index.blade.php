    ...
    <div class="container">
        ...
        <div class="box-body">
            ...
            <div class="box-header with-border">
                {!! Form::model("", ['route' => ['preparation_galaries.store',$id],
                ...
                <div class="form-group" >
                    <label> @lang('site.add_preparation_imgs')</label>
                    ...
                    @foreach ($posts as $post)
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <form action="{{url(route("preparation_galaries.destroy",$post->id)) }}" method="post" style="display: inline-block">
                                    {{ csrf_field() }}
                                    {{ method_field('delete') }}
