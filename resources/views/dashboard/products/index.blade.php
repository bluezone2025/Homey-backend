@extends('dashboard.layouts.app')
    ...
    @section('content')
        <div class="container">
            ...
            <th width="10%">@lang('site.price')
            </th>
            <th width="20%">@lang('site.img')
            </th>
            <th width="10%">@lang('site.Number of sales')</th>
            <th width="10%">@lang('site.Total Quantity')</th>
            <th width="10%">@lang('site.Total sales')</th>
