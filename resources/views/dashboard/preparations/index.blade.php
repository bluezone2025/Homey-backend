@extends('dashboard.layouts.app')
    ...
    @section('page_title')  @lang('site.preparations')  @endsection
            ...
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    ...
                    <div class="pull-right">
                        {{--                <a class="btn btn-success mb-2" id="new-user" data-toggle="modal">New User</a>--}}
                        <a class="btn btn-success mb-2" href="{{route('preparations.create')}}">@lang('site.add_preparation')</a>
                    </div>
                </div>
            </div>
