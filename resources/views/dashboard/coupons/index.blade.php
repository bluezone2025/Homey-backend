...
@section('page_title')  @lang('site.coupon')  @endsection
@section('style')
        ...
        <div class="row">
            <div class="col-lg-12 margin-tb">
                <div class="pull-right">
                    ...
                    <a class="btn btn-success mb-2" href="{{route('coupons.create')}}">@lang('site.new_coupon')</a>
                </div>
            </div>
        </div>
            ...
            <div class="table-responsive p-0">
                <table class="table align-items-center justify-content-center mb-0 data-table  text-secondary text-xs ">
                    ...
                    <tr>
                        ...
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">@lang('site.percentage')</th>
