            ...
            <div class="table-responsive p-0">
                <table class="table align-items-center justify-content-center mb-0 data-table  text-secondary text-xs ">
                    ...
                    <tr>
                        ...
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">@lang('site.country_code_en')</th>
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">@lang('site.country_code_ar')</th>
        ...
        $(document).ready(function () {
            ...
            var table = $('.data-table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'country_code_ar', name: 'country_code_ar'},
