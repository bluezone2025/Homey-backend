...
@section('page_title') @lang('site.edit_delivery_time') @endsection
...
@endsection
@section('content')
    <form class="card col-md-12 col-12" style="margin: auto" action="{{ route('delivery_times.update.delivery_time', $delivery_time->id) }}"
            ...
            @endif
                ...
                <div class="d-flex flex-wrap">
                    <div class="form-group col-6">
                        ...
                        <input value="{{$delivery_time->begin_time}}" type="time" name="begin_time"
                    ...
                    <div class="form-group col-6">
                        ...
                        <input value="{{$delivery_time->end_time}}" type="time" name="end_time"
