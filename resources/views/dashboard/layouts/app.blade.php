...
{{--    </title>--}}
    ...
    <style>
        .bg-gradient-primary {
            background-image: linear-gradient(310deg, #811b07 0%, #811b07 100%);
        }
...
{{--            </li>--}}
            ...
            <li class="nav-item">
                <a class="nav-link  {{ (explode(".", Request::route()->getName())[0] == 'roles') ? 'active' : '' }} "
                   href="{{route('admin.roles')}}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title> @lang('site.Roles')</title>
                            <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g id="Rounded-Icons" transform="translate(-1869.000000, -293.000000)" fill="#FFFFFF" fill-rule="nonzero">
                                    <g id="Icons-with-opacity" transform="translate(1716.000000, 291.000000)">
                                        <g id="office" transform="translate(153.000000, 2.000000)">
            ...
            @permission('manage-banners')
            <li class="nav-item">
                <a class="nav-link  {{ (explode(".", Request::route()->getName())[0] == 'ads') ? 'active' : '' }} "
                   href="{{route('ads.index')}}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>Home Page Ads</title>
                            <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g id="Rounded-Icons" transform="translate(-1869.000000, -293.000000)" fill="#FFFFFF" fill-rule="nonzero">
                                    <g id="Icons-with-opacity" transform="translate(1716.000000, 291.000000)">
                                        <g id="office" transform="translate(153.000000, 2.000000)">
            ...
            @permission('manage-basic-categories')
            <li class="nav-item">
            ...
            @permission('manage-sub-categories')
            <li class="nav-item">
            ...
            @permission('manage-sub-categories')
            <li class="nav-item">
                <a class="nav-link  {{ (explode(".", Request::route()->getName())[0] == 'brands') ? 'active' : '' }} "
...
{{--            @permission('manage-preparations')--}}
{{--            <li class="nav-item">--}}
{{--                <a class="nav-link  {{ (explode(".", Request::route()->getName())[0] == 'preparations') ? 'active' : '' }} "--}}
...
{{--            @endpermission--}}
            ...
            @permission('manage-delivery-times')
            <li class="nav-item">
                <a class="nav-link  {{ (explode(".", Request::route()->getName())[0] == 'delivery_times') ? 'active' : '' }} "
                   href="{{route('delivery_times.index')}}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>delivery_times</title>
                            <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g id="Rounded-Icons" transform="translate(-1869.000000, -293.000000)" fill="#FFFFFF" fill-rule="nonzero">
                                    <g id="Icons-with-opacity" transform="translate(1716.000000, 291.000000)">
                                        <g id="office" transform="translate(153.000000, 2.000000)">
            ...
            @permission('manage-not-paid-orders')
            <li class="nav-item">
            ...
            @permission('manage-cash-orders')
            <li class="nav-item">
                <a class="nav-link  {{ (explode(".", Request::route()->getName())[0] == 'cashorders') ? 'active' : '' }} "
                   href="{{route('cashorders')}}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>Cash Orders</title>
                            <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g id="Rounded-Icons" transform="translate(-1869.000000, -293.000000)" fill="#FFFFFF" fill-rule="nonzero">
                                    <g id="Icons-with-opacity" transform="translate(1716.000000, 291.000000)">
                                        <g id="office" transform="translate(153.000000, 2.000000)">
            ...
            <li class="nav-item">
                <a class="nav-link  {{ (explode(".", Request::route()->getName())[0] == 'notifications') ? 'active' : '' }} "
                    ...
                    @if(explode(".", Request::route()->getName())[0] == 'admin')
                        ...
                        <form method="GET" action="{{ route('admin') }}">
                            <select name="country_id" class="form-control" onchange="this.form.submit()">
                                @php
                                    $countries = App\Country::with('currency')
...
{{--                        </li>--}}
{{--                        <li class="nav-item">--}}
{{--                            <a class="nav-link" href="{{route('basic_categories.index')}}">--}}
{{--                                الأقسام الرئيسيه--}}
{{--                            </a>--}}
{{--                        </li>--}}
{{--                        <li class="nav-item">--}}
...
{{--                        </li>--}}
{{--                        <li class="nav-item">--}}
{{--                            <a class="nav-link" href="{{route('settings.show' , 1)}}">--}}
{{--                                الإعدادات--}}
{{--                            </a>--}}
{{--                        </li>--}}
...
{{--                        {{$my_setting->site_name_en}}  /     {{$my_setting->site_name_ar}}--}}
{{--                    </h1>--}}
{{--                </div>--}}
{{--                <div class="p-1 flex flex-row items-center">--}}
{{--                    <img onclick="profileToggle()" class="inline-block h-8 w-8 rounded-full" src="{{ asset('/storage/'. $my_setting->logo)}}" alt="">--}}
