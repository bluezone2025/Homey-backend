...
<div class="form-group col-md-6">
    ...
    <input name="name_ar" type="text" class="form-control @error('name_ar') is-invalid @enderror" id="name_ar" placeholder="@lang('form.placeholder.product name ar')" value="{{old('name_ar' , $product->name_ar)}}" required>
...
<div class="form-group col-md-6">
    ...
    <input name="name_en" type="text" class="form-control @error('name_en') is-invalid @enderror" id="name_en" placeholder="@lang('form.placeholder.product name en')" value="{{old('name_en' , $product->name_en)}}" required>
...
<div class="form-group col-md-6">
    ...
    <input name="brand_name" type="text"  class="form-control @error('brand_name') is-invalid @enderror" id="name_en"  value="{{old('brand_name', $product->brand_name)}}" required>
