...
class ColorController extends Controller
{
    ...
    public function index()
    {
        ...
        return  $this->MDT_Query_method(// Start Query
            Option::class ,
            'admin/pages/colors/index',
            $is_trash, // Soft Delete
            [ // Other Options
                'condition' => ['where' , 'attribute_id' , '=' , 7],
    ...
    public function store(OptionRequest $request)
    {
        ...
        return back()->with('success' ,  __('form.response.create color'));
    ...
    public function update(OptionRequest $request, $id)
    {
        ...
        return response(['status' => 'success' , 'message' => __('form.response.update color')]);
    }
