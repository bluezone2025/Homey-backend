...
trait MDT_UploadImag2
{
    ...
    public function MDT_saveImage($file , $name , $path ='assets/images/boxes/min/'){
...
//                $constraint->upsize();
    ...
    public function MDT_saveMultiImage($files, $name , $fk_id=['nameKey' , 'id'] , $path='assets/images/boxes/gallery/' ){
       ...
       foreach ($files as $file){
           ...
           $saveNameFile[$count]['image'] = $fileName;
    ...
    public function MDT_deleteImage($img , $path ='assets/images/boxes/min'){
    ...
    public function MDT_deleteMultiImage($images , $path ='assets/images/boxes/gallery'){
